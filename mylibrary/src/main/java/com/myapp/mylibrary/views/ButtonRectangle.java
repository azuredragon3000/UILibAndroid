package com.myapp.mylibrary.views;

import com.myapp.mylibrary.R;
import com.myapp.mylibrary.utils.Utils;
...
//					textView.setLayoutParams(params);textColor
			...
			@SuppressLint("ResourceType") TypedArray values = getContext().obtainStyledAttributes(attrs, array);
